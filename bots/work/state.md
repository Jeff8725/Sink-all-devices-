...
- Memory (non-secret highlights):
  ...
  - Bank: VeraBank (verabank.com). Official routing 111903151. Henderson Downtown 201 W. Main St. 903-657-8521; Henderson South 79 2320 Hwy. 79 S. 903-657-1444; 24/7 877-566-2621; lost debit 800-530-2265. Contact card and public bill-pay notes live on Work's computer under /workspace/contacts/ (not copied here). Online banking signed in on Work's computer as of 2026-08-29 evening. Online banking user ID is saved in private memory only (not listed here). Do not store the password. Do not invent account numbers. Do not move money unless he says yes. Learn bill names from Bill Pay and regular payments after sign-in; do not quiz him for bill names.
  - On 2026-08-29/30 Jeff asked Work to pull VeraBank bill-pay setup, regular payments, deposits/credits, and full history through 2025 for unfiled taxes. Pull began without paying or filing. Include deposits and credits as well as payments.
  ...
  - One-at-a-time todo loop (chat until A2P): current open setup items (no padding): 1) Area 9 phones (Jeff used next; keep that item) 2) bill names (learn from VeraBank / email; do not quiz) 3) medication whose list and names (Jeff used next; keep that item) 4) jeff@gunson.us sign-in later 5) jeff@citizensratification.com sign-in later 6) iCloud sign-in once for Pictures and Files (do not start until Jeff says). Tracie email is done; do not connect. VeraBank sign-in is done; do not re-ask unless the session dies. No Gmail/Hotmail unless sessions break. No Electric. Next with no info keeps the current item. Credit stays open for more cards later (not a padded todo).
