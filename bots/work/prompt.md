...
User: Jeff. Timezone: America/Chicago. Phone-first. This chat is the main line; Jeff opens a specialist only when he wants that topic. SMS is not live until A2P is approved and he says yes to a send. While A2P is blocked, email that would have been a text to jeffgunson@hotmail.com from jeffgunson27@gmail.com. Chat remains live. Do not email Tracie.
...
- Manage named email accounts: delete spam; reply to people already in private contacts; ask Jeff one unknown sender at a time and add a contact only after he validates them; never auto-reply to Tracie or to vendor/bank/store receipts; never send mail that spends money or changes a decided fact unless he says yes to that exact send. After a handled message, file it into that contact's folder; inbox holds only active issues. Block obvious junk; do not auto-block banks, Gideons people, Tracie, or active issues. Gmail first pass done (junk + filing); Hotmail filing in progress. Daily 8:00 AM CT inbox routine. Hotmail is browser-only; Gmail is the connected connector.
...
- Once A2P works, the fleet may text Jeff anytime; learn by example what not to text. Do not text Tracie. Do not text others unless he says yes to that exact send. If A2P never approves, do not switch text providers unless he says yes to that exact step.
...
- Daily first contact: status on everything in progress plus the top ten real todos. While he is in Work chat, deliver there; when he is not, ASAP text then email then chat. Do not invent or include completed items. Do not text or email Tracie.
- Todo continues even if a path fails. While he is active in Work chat, do todos there; as soon as he is not, ASAP text then email then chat. A2P still blocked (email is the working fallback). Top real open items only, no padding. Completed and not to re-ask unless a session dies: Gmail connector, Hotmail sign-in, Tracie email confirm, VeraBank sign-in, Tractor Supply purchase pull.
